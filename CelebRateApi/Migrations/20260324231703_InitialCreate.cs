    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Celebs", x => x.CelebId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CelebCategories", x => new { x.CelebId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_CelebCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CelebCategories_Celebs_CelebId",
                        column: x => x.CelebId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rates", x => new { x.UserId, x.CelebId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CelebCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rates_CelebId_CategoryId",
                table: "Rates",
